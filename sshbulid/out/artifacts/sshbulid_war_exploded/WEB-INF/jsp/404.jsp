						...
						<div class="nav-wrapper w100dt">
							...
							<div>
								...
								<ul id="nav-mobile" class="main-menu center-align hide-on-med-and-down">
									<li><a href="${pageContext.request.contextPath}/Controller/customer?getindex=1">HOME</a></li>
									...
									<li><a href="single-blog1.jsp">BLOG SINGLE</a></li>
								...
								<ul class="side-nav" id="mobile-demo">
									...
									<li><a href="contact.html">CONTACT</a></li>
									<li class="active"><a href="404.jsp">404 PAGE</a></li>
								</ul>
							</div>
							<!-- main-menu -->
			...
			<div class="container">
				...
				<nav class="breadcrumb-nav w100dt">
					...
					<div class="nav-wrapper right">
						...
						<a href="404.jsp" class="breadcrumb active">404 ERROR</a>
					</div>
					<!-- /.nav-wrapper -->
				</nav>
				<!-- /.breadcrumb-nav -->
