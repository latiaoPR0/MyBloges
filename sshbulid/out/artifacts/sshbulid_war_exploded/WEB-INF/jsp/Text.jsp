						...
						<div class="nav-wrapper w100dt">
							...
							<div>
								...
								<ul id="nav-mobile" class="main-menu center-align hide-on-med-and-down">
									<li><a href="${pageContext.request.contextPath}/Controller/customer?getindex=1">首页</a></li>
									<li><a href="cateogry.html">分类</a></li>
									<li class="dropdown">
								...
								<ul class="side-nav" id="mobile-demo">
									...
									<li><a href="cateogry.html">分类</a></li>
									<li class="active"><a href="single-blog1.jsp">SINGLE BLOG</a></li>
									<li><a href="联系.html">联系</a></li>
									<li><a href="404.jsp">404 PAGE</a></li>
								</ul>
							</div>
			...
			<div class="container">
				...
				<nav class="breadcrumb-nav w100dt">
					...
					<div class="nav-wrapper right">
						...
						<a href="single-blog1.jsp" class="breadcrumb active">博客单</a>
					</div>
					<!-- /.nav-wrapper -->
				</nav>
				<!-- /.breadcrumb-nav -->
						...
						<div class="blogs mb-30">
							<div class="card">
								<div class="card-image">
									<img src="${itemList.t_img}" alt="Image">
								</div>
								<!-- /.card-image -->
								<div class="card-content w100dt">
									<p>
										<a href="#" class="tag left w100dt l-blue mb-30">${itemList.t_type}</a>
									</p>
									...
									<ul class="post-mate-time left mb-30">
										<li>
											<p class="hero left">
												By - <a href="#" class="l-blue">${itemList.t_author}</a>
											</p>
										</li>
										<li>
											<i class="icofont icofont-ui-calendar"></i> ${itemList.t_date}
										</li>
									</ul>
