        ...
        <div class="container">
            <div class="row">
                <div class="nav-wrapper w100dt">
                    ...
                    <div class="logo left">
                        <a href="${pageContext.request.contextPath}/Controller/customer?getindex=1" class="brand-logo">
                            <img src="../img/ceshi.png" alt="brand-logo">
                        </a>
                    </div>
                    <!-- logo -->
                    ...
                    <div>
                        ...
                        <ul id="nav-mobile" class="main-menu center-align hide-on-med-and-down">
                            <li class="active"><a
                                    href="${pageContext.request.contextPath}/Controller/customer?getindex=1">首页</a></li>
                            <li><a href="${pageContext.request.contextPath}/404">类别</a></li>
                            <li class="dropdown">
                                <a href="#">页面 <i class="icofont icofont-simple-down"></i></a>
                                <ul class="dropdown-container">
                                    <li><a href="${pageContext.request.contextPath}/404">404 Page</a></li>
                                </ul>
                                <!-- /.dropdown-container -->
                            </li>
                            <li><a href="single-blog1.jsp">博客单</a></li>
                        ...
                        <ul class="side-nav" id="mobile-demo">
                            ...
                            <li><a href="single-blog1.jsp">SINGLE BLOG</a></li>
        ...
        <div class="slider">
            <ul class="slides">
                <li class="slider-item">
                    <img src="../../img/beijin1.jpeg" alt="Image">
                    <div class="caption center-align">
                        ...
                        <p>
                            我想我已经有足够的时间来思考这个问题了。我想我已经有足够的时间来思考这个问题了。
                        </p>
                        <a href="single-blog1.jsp" class="custom-btn waves-effect waves-light">READ MORE</a>
                    </div>
                </li>
                <li class="slider-item">
                    <img src="../../img/bj1.jpg" alt="Image">
                ...
                <li class="slider-item">
                    <img src="../../img/beijin2.jpg" alt="Image">
...
<section id="daily-lifestyle-section" class="daily-lifestyle-section mb-50">
    <div class="container">
        <div class="owl-carousel small-carousel owl-theme">
            <%-- ===========测试开始=======--%>
            <c:forEach items="${Userinfo.list}" var="twoItem" begin="0" end="5">
            <div class="item">
                <div class="card horizontal">
                    <div class="card-image">
                        <img src="${twoItem.t_imgportrait}" alt="Image">
                        <span class="effect"></span>
                    </div>
                    <!-- /.card-image -->
                    <div class="card-stacked">
                        <div class="card-content">
                            <a href="#" class="tag left l-blue mb-10">${twoItem.t_type}</a>
                            <a href="${pageContext.request.contextPath}/itemEdit.action?id=${twoItem.t_id}"
                               class="sm-name">${twoItem.t_title}</a>
                        </div>
                        <!-- /.card-content -->
                        <div class="card-action">
                            <p class="hero left">
                                BY - <a href="#" class="l-blue">${twoItem.t_author}</a>
                            </p>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col s12 m8 l8">
                ...
                <c:forEach items="${Userinfo.list}" var="oneItem" begin="1" end="4">
                    <div class="blogs mb-30">
                        <div class="card">
                            <div class="card-image">
                                <img src="${oneItem.t_img}" alt="Image">
                            ...
                            <div class="card-content w100dt">
                                <p>
                                    <a href="#" class="tag left w100dt l-blue mb-30">${oneItem.t_type}</a>
                                </p>
                                <a href="${pageContext.request.contextPath}/itemEdit.action?id=${oneItem.t_id}"
                                   class="card-title">
                                        ${oneItem.t_title}
                                </a>
                                <p class="mb-30">
                                ...
                                <ul class="post-mate-time left">
                                    <li>
                                        <p class="hero left">
                                            By - <a href="#" class="l-blue">${oneItem.t_author}</a>
                                        </p>
                                    </li>
                                    <li>
                                        <i class="icofont icofont-ui-calendar"></i> ${oneItem.t_date}
                                    </li>
                                </ul>
                ...
                <%-- ----------------分页操作--------------- --%>
                <%--${pageContext.request.contextPath}/itemEdit.action?id=${oneItem.t_id}--%>
                <ul class="pagination w100dt">
                    <%-- 上一页 --%>
                    <li class="waves-effect">
                        <a href="${pageContext.request.contextPath}/Controller/customer?getindex=${Userinfo.pageIndex==1 ? 1:Userinfo.pageIndex-1}">
                            <i class="icofont icofont-simple-left">
                            </i></a></li>
                    <c:forEach begin="1" end="${Userinfo.pageSum}" varStatus="loop">
                        <c:set var="active" value="${loop.index==Userinfo.pageIndex?'active':''}"/>
                        <li class="${active}">
                            <a href="<c:url value="${pageContext.request.contextPath}/Controller/customer?getindex=${loop.index}"/>">
                                    ${loop.index}
                            </a>
                        </li>
                    </c:forEach>
                    <%-- 下一页 --%>
                    <li class="waves-effect">
                        <a href="${pageContext.request.contextPath}/Controller/customer?getindex=${Userinfo.pageIndex== Userinfo.pageSum ? Userinfo.pageSum:Userinfo.pageIndex+1}">
            ...
            <div class="col s12 m4 l4">
                ...
                <div class="featured-posts w100dt mb-30">
                    ...
                    <div class="sidebar-posts">
                        <c:forEach items="${Userinfo.list}" var="listteshe" begin="0" end="2">
                            <div class="card">
                                <div class="card-image mb-10">
                                    <img src="${listteshe.t_img}" alt="Image">
                                    <span class="effect"></span>
                                </div>
                                <!-- /.card-image -->
                                <div class="card-content w100dt">
                                    <p>
                                        <a href="#" class="tag left w100dt l-blue mb-10">${listteshe.t_type}</a>
                                    </p>
                                    <a href="${pageContext.request.contextPath}/itemEdit.action?id=${listteshe.t_id}" class="card-title">
                                        ${listteshe.t_title}
                                    </a>
                                    <ul class="post-mate-time left">
                                        <li>
                                            <p class="hero left">
                                                By - <a href="#" class="l-blue">${listteshe.t_author}</a>
                                            </p>
                                        </li>
                                    </ul>
                        ...
                        <%--                                </p>--%>
                        <%--                                <a href="single-blog1.jsp" class="card-title">--%>
                ...
                <div class="top-post w100dt mb-30">
                        ...
                        <div class="sidebar-posts">
                            ...
                            <div class="hot-post w100dt mb-10">
                                ...
                                <div class="hot-post-stacked">
                                    ...
                                    <a href="single-blog1.jsp" class="sm-name mb-10">Trud Exercitation EllaMcop
                                        Saboris</a>
                    ...
                    <div id="test-swipe-2" class="tab-contant recent-post">
                        ...
                        <div class="hot-post w100dt p-15">
                            ...
                            <div class="hot-post-stacked">
                                ...
                                <a href="single-blog1.jsp" class="sm-name mb-10">Trud Exercitation EllaMcop Saboris</a>
                                <div class="hot-post-action">
                                    <p class="hero left">
                                        BY - <a href="#" class="l-blue">SujonMaji</a>
                                    </p>
                    ...
                    <div id="test-swipe-3" class="tab-contant Comments-post">
                        ...
                        <div class="card-panel grey lighten-5 z-depth-1">
                            <div class="row valign-wrapper">
                                <div class="col s3">
                                    <img src="../../img/img2.png" alt="Image" class="circle responsive-img">
                                    <!-- notice the "circle" class -->
                                </div>
                                <div class="col s9">
                                                <span class="black-text">
                        ...
                        <div class="card-panel grey lighten-5 z-depth-1">
                            <div class="row valign-wrapper">
                                <div class="col s3">
                                    <img src="../../img/img3.png" alt="Image" class="circle responsive-img">
                                    <!-- notice the "circle" class -->
                                </div>
                                <div class="col s9">
                                                <span class="black-text">
...
<section id="instagram-section" class="instagram-section w100dt">
    ...
    <div class="instagram-link w100dt">
        <a href="#">
            <span>FIND US ON INSTAGRAM</span> @Latiao PRO
        </a>
    </div>
...
<footer id="footer-section" class="footer-section w100dt">
    <div class="container">
        ...
        <p class="center-align">
            ...
            <a href="#" class="l-blue">2020</a>练习页面 <a href="${pageContext.request.contextPath}/404" target="_blank"
                                                       title="LatiaoPro">LatiaoPro</a> - china <a
                href="${pageContext.request.contextPath}/404" title="LatiaoPro" target="_blank">LatiaoPro</a> - 测试
            <a href="${pageContext.request.contextPath}/404" target="_blank" title="LatiaoPro">LatiaoPro</a> - 测试 <a
                href="${pageContext.request.contextPath}/404" title="LatiaoPro" target="_blank">LatiaoPro</a>
        </p>
